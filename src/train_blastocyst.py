...
from src.config import (  # noqa: E402
    SegmentationConfig, DatasetConfig, ModelConfig,
    TrainingConfig, LossConfig, AugmentationConfig
)
from src.segmentation_utils.generalized_dataset import (  # noqa: E402
    create_data_splits
)
...
from src.segmentation_utils.device_utils import (  # noqa: E402
    get_best_device, print_device_info
)
...
def create_blastocyst_config(args) -> SegmentationConfig:
    ...
    dataset_config = DatasetConfig(
        ...
        class_names=[
            "background", "zona_pellucida",
            "inner_cell_mass", "trophectoderm"
        ],
...
def main():
    parser = argparse.ArgumentParser(
        description="Train blastocyst segmentation model"
    )
    
    # Data arguments
    parser.add_argument("--data_dir", type=str, default="./data/BLASTOCYST",
                        help="Path to blastocyst data directory")
    parser.add_argument("--problem_type", type=str, default="multiclass",
    ...
    parser.add_argument("--loss", type=str, default="auto",
                        help="Loss function (auto, DiceLoss, FocalLoss, etc.)")
    ...
    if 'test' in datasets:
        test_indices_file = (
            ...
            f"{config.task_name}_test_indices.txt"
        )
